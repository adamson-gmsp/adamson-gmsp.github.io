...
bar_V5 = cca_data %>%
  ...
  coord_flip() +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 30)) +
  scale_y_continuous(labels = scales::percent, limits = c(0,5000000), breaks = seq(0,5000000,1000000))+
  xlab("") +
  ylab("") +
  theme(
    plot.background = element_rect(fill = "white"),
...
bar_V11 = cca_data %>%
  ...
  coord_flip() +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 30)) +
  scale_y_continuous(labels = scales::percent, limits = c(0,10000000), breaks = seq(0,10000000,2000000))+
  xlab("") +
  ylab("") +
  theme(
    plot.background = element_rect(fill = "white"),
