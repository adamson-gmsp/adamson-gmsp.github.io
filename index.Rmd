...
valueBox(value = box2,icon = NA,caption = "MSP Region, 2024",color = "lightblue")
```
...
valueBox(value = box3,icon = box3_icon,caption = "MSP trend from 2023", color = "lightblue")
```
